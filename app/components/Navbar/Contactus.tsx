...
const Carousel: React.FC<CarouselProps> = ({
  ...
  if (numImages === 0) {
    return <div style={{ width: width, height: height }}>No images provided.</div>;
  }
  ...
  return (
    <div className="relative w-full max-w-6xl overflow-hidden rounded-lg shadow-md" style={{ width: width, height: height }}>
